    ...
    public virtual RouteHandlerBuilder MapGetV1(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        (
            ...
            (
				...
				[FromServices] MinimalApiGen.Generators.IntegrationTests.Fixtures.ISampleService2 iSampleService2
            ) =>
            {
                ...
                {
                    IEnumerable<SampleModel> models = await handler.GetModelsAsync(iSampleService1, iSampleService2, cancellationToken).ConfigureAwait(false);
