    ...
    public virtual RouteHandlerBuilder MapGetV1(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        (
            ...
            (
				...
				[FromKeyedServices("SampleService")] MinimalApiGen.Generators.SnapshotTests.Fixtures.ISampleService sampleService
            ) =>
            {
                ...
                {
                    IEnumerable<SampleModel> models = await businessLogic.GetModelsAsync(sampleService, cancellationToken).ConfigureAwait(false);
